...
export const en: Translations = {
  ...
  "timer.setupTitle": "Timer Queue",
  "timer.add": "+ Add Timer",
  "timer.append": "Append",
  "timer.appendHint": "Adds to the end of the current queue",
  "timer.overwrite": "Apply",
  "timer.overwriteHint": "Replaces the queue and stops any running timer",
  "timer.cancel": "Cancel",
  "timer.namePlaceholder": "Timer name (optional)",
  "timer.mode": "Mode",
  "timer.minutes": "min",
  "timer.seconds": "sec",
  ...
  "timer.unnamed": "Timer",
  "timer.invalid": "Fix the timer list first: every countdown needs a duration of 1 second or more",
  "timer.remove": "Remove timer",
  "timer.clear": "Clear",
  "timer.clearHint": "Removes the whole queue and stops any running timer",
  "timer.restore": "Show timer window",
  "timer.expand": "Expand timer",
  "timer.collapse": "Collapse timer",
  "timer.minimize": "Minimize to top bar",
